...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
        ...
        ChessPiece movedPiece = (ChessPiece)board.piece(target); // <- variable for specialmoves treatment
    ...
    public ChessPiece replacePromotedPiece(String type) {
        ...
        if(!type.equals("B") && !type.equals("C") && !type.equals("T") && !type.equals("D") && !type.equals("P")) {
            return promoted;
        }
    ...
    private ChessPiece newPiece(String type, Color color) {
        ...
        if (type.equals("T")) return new Queen(board, color);
    ...
    private ChessPiece king(Color color) {
        // returns the king piece of a given color
